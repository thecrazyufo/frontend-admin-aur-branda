...
function AdminLoginForm() {
  ...
  return (
    <div className="relative min-h-screen bg-zinc-950 flex items-center justify-center py-16 px-4 font-sans overflow-hidden">
      {/* Background Glow */}
      ...
      <Card className="w-full max-w-sm bg-zinc-900/60 border-zinc-850 p-6 z-10 shadow-2xl shadow-black/80 backdrop-blur-md">
        {/* Back Link */}
        <Link 
          href="/" 
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-xs font-bold text-zinc-350 tracking-wider uppercase">Multi-Tenant Admin Portal</span>
        </div>
        ...
        <div className="mb-6">
          <h1 className="text-xl font-extrabold tracking-tight text-zinc-50">Admin Panel</h1>
          <p className="text-xs text-zinc-500 mt-1">Sign in to manage your platform</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4" id="admin-login-form">
          <div className="space-y-1.5">
            <label htmlFor="admin-username" className="text-xs font-medium text-zinc-400">Username</label>
            <div className="relative flex items-center">
              <svg className="absolute left-3 text-zinc-500" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
              ...
              <Input
                id="admin-username"
                type="text"
                className="pl-9 h-10 border-zinc-800 bg-zinc-950/50 text-zinc-200 placeholder:text-zinc-500 focus-visible:ring-indigo-500/20 focus-visible:border-indigo-500"
          ...
          <div className="space-y-1.5">
            <label htmlFor="admin-password" className="text-xs font-medium text-zinc-400">Password</label>
            <div className="relative flex items-center">
              <svg className="absolute left-3 text-zinc-500" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
              ...
              <Input
                ...
                className="pl-9 pr-9 h-10 border-zinc-800 bg-zinc-950/50 text-zinc-200 placeholder:text-zinc-500 focus-visible:ring-indigo-500/20 focus-visible:border-indigo-500"
              ...
              <button
                type="button"
                className="absolute right-3 text-zinc-500 hover:text-zinc-400 focus:outline-none"
        ...
        <p className="text-center text-[10px] text-zinc-600 mt-6 select-none">
...
export default function AdminLoginPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center text-xs font-semibold text-zinc-500">
