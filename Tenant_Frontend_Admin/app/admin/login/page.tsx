...
function AdminLoginForm() {
 ...
 <Card className="w-full max-w-sm bg-zinc-900/60 border-border p-6 z-10 shadow-2xl shadow-black/80 backdrop-blur-md">
 {/* Back Link */}
 <Link 
 href="/" 
 ...
 <div className="mb-6">
 <h1 className="text-xl font-extrabold tracking-tight text-muted-foreground">Admin Panel</h1>
 ...
 id="admin-username"
 type="text"
 className="pl-9 h-10 border-zinc-800 bg-background text-zinc-200 placeholder:text-zinc-500 focus-visible:ring-indigo-500/20 focus-visible:border-indigo-500"
 ...
 className="pl-9 pr-9 h-10 border-zinc-800 bg-background text-zinc-200 placeholder:text-zinc-500 focus-visible:ring-indigo-500/20 focus-visible:border-indigo-500"
