    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      {seoToast && (
        <div className={cn(
          ...
          seoToast.type === "success" ? "border-emerald-500/20 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400" : "border-red-500/20 bg-red-500/10 text-red-600 dark:text-red-400"
        )}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-zinc-200 dark:border-zinc-800 pb-5 gap-4">
        <div className="space-y-1">
          <h1 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">SEO & Settings</h1>
      ...
      {activeTab === "seo" && (
        <div className="space-y-6">
          {editing && (
            <div className="fixed inset-0 bg-white dark:bg-zinc-950 z-50 flex flex-col overflow-hidden animate-fade-in">
              ...
              <div className="flex items-center justify-between px-6 py-4 bg-zinc-50 dark:bg-zinc-900/50 border-b border-zinc-200 dark:border-zinc-800 shrink-0">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 mr-3 select-none">
                    <span className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Live SEO Score:</span>
                    <span 
              ...
              <div className="flex flex-1 overflow-hidden">
                {/* Left Audit Sidebar */}
                <aside className="w-80 bg-zinc-50 dark:bg-zinc-900/50 border-r border-zinc-200 dark:border-zinc-800 p-6 flex flex-col gap-6 shrink-0 overflow-y-auto">
                  <h3 className="text-xs font-bold text-zinc-900 dark:text-zinc-155 uppercase tracking-widest">SEO Audit Checklist</h3>
                    ...
                    {[
                      ...
                      >
                        ...
                        <div className="space-y-0.5">
                          ...
                          <span className="text-[10px] text-zinc-400 dark:text-zinc-500 block">{check.desc}</span>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="border-t border-zinc-200 dark:border-zinc-800 pt-4 space-y-2">
                    <div className="flex justify-between text-xs font-bold text-zinc-900 dark:text-zinc-150">
                ...
                <main className="flex-1 p-8 overflow-y-auto bg-white dark:bg-zinc-950">
                  <div className="max-w-3xl mx-auto space-y-6">
                    <Card className="dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-6">
                      <CardHeader className="px-0 pt-0 pb-4 border-b border-zinc-100 dark:border-zinc-800 mb-6">
                      ...
                      <CardContent className="px-0 pb-0 space-y-4">
                        ...
                        <div className="space-y-1.5">
                          <label className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Canonical URL</label>
                          <Input
                            type="url"
                        ...
                        <div className="space-y-1.5">
                          <label className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Keywords (comma-separated)</label>
                          <Input
                            type="text"
                            value={keywordsStr}
                            onChange={(e) =>
                    ...
                    <Card className="dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-6">
                      ...
                      <CardContent className="px-0 pb-0 space-y-4">
                        <div className="space-y-1.5">
                          <label className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">OG Title</label>
                          <Input
                            type="text"
                        ...
                        <div className="space-y-1.5">
                          <label className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">OG Description</label>
                          <textarea
                        ...
                        <div className="space-y-1.5">
                          <label className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">OG Image URL</label>
                          <Input
                            type="text"
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 mt-6 mb-4">
            <div className="flex gap-1 bg-zinc-100 dark:bg-zinc-900 p-1 rounded-lg border border-zinc-200 dark:border-zinc-800 shrink-0 select-none">
              {(["all", "product", "blog"] as const).map((f) => (
                <button
                  ...
                  className={cn(
                    ...
                    filter === f
                      ? "bg-white dark:bg-zinc-850 shadow-sm text-zinc-900 dark:text-zinc-100"
          ...
          {seoLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredSeo.map((item) => {
                ...
                return (
                  <Card key={`${item.type}-${item.id}`} className="dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col justify-between">
        ...
        <div className="space-y-6">
          {settingsLoading ? (
            ...
            <form onSubmit={handleSaveSettings} className="space-y-6">
              {settingsSuccess && (
                <div className="p-3.5 rounded-lg border border-emerald-200 dark:border-emerald-900/30 bg-emerald-50/50 dark:bg-emerald-950/20 text-xs font-semibold text-emerald-600 dark:text-emerald-400">
                  {settingsSuccess}
                </div>
              )}
              {settingsError && (
                <div className="p-3.5 rounded-lg border border-red-205 dark:border-red-900/30 bg-red-50/50 dark:bg-red-950/20 text-xs font-semibold text-red-600 dark:text-red-400">
                  {settingsError}
                </div>
              )}
            ...
            <div className="text-center py-10 text-sm text-zinc-500 dark:text-zinc-400">No settings configurations seeded.</div>
          )}
        </div>
      )}
    </div>
