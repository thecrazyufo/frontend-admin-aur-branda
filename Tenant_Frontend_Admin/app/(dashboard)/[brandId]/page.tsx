  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-200/60 dark:border-zinc-800/60 pb-6">
        <div>
          <h2 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">{brandName} Overview</h2>
          <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{brandTagline}</p>
        </div>
        <div className="flex items-center gap-2">
          <Badge variant="outline" className="text-[10px] font-bold tracking-wider uppercase py-1 border-indigo-200 dark:border-indigo-900/30 bg-indigo-50/10 text-indigo-600 dark:text-indigo-400">
            Active Storefront
          </Badge>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Metric 1 */}
        <Card className="bg-white/40 dark:bg-zinc-900/30 backdrop-blur-md border-zinc-200 dark:border-zinc-800/80">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-3xl font-extrabold tracking-tight text-zinc-900 dark:text-zinc-50 mt-1">{productCount}</CardTitle>
          </CardHeader>
        ...
        {isLicenseAdmin && (
          <Card className="bg-white/40 dark:bg-zinc-900/30 backdrop-blur-md border-zinc-200 dark:border-zinc-800/80">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-3xl font-extrabold tracking-tight text-zinc-900 dark:text-zinc-50 mt-1">{desktopLicCount}</CardTitle>
            </CardHeader>
            <CardContent className="h-10 flex items-end">
        ...
        {isLicenseAdmin && (
          <Card className="bg-white/40 dark:bg-zinc-900/30 backdrop-blur-md border-zinc-200 dark:border-zinc-800/80">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-3xl font-extrabold tracking-tight text-zinc-900 dark:text-zinc-50 mt-1">{webLicCount}</CardTitle>
            </CardHeader>
            <CardContent className="h-10 flex items-end">
        ...
        <Card className="bg-white/40 dark:bg-zinc-900/30 backdrop-blur-md border-zinc-200 dark:border-zinc-800/80">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-3xl font-extrabold tracking-tight text-zinc-900 dark:text-zinc-50 mt-1">{seoScore}%</CardTitle>
          </CardHeader>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          {isLicenseAdmin && (
            <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800/80">
              <CardHeader className="border-b border-zinc-100 dark:border-zinc-800/60 pb-4">
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-sm font-bold text-zinc-900 dark:text-zinc-50">Recent Licenses Issued</CardTitle>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {recentLicenses.map((lic) => (
                        <TableRow key={lic.id} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/20">
                          <TableCell className="py-2.5 font-medium text-xs text-zinc-800 dark:text-zinc-200">{lic.type}</TableCell>
                          <TableCell className="py-2.5 font-mono text-[11px] tracking-tight text-zinc-900 dark:text-zinc-100">
          ...
          <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800/80">
            <CardHeader className="border-b border-zinc-100 dark:border-zinc-800/60 pb-4">
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-sm font-bold text-zinc-900 dark:text-zinc-50">Catalog Snapshot</CardTitle>
                ...
                <Table>
                  ...
                  <TableBody>
                    {recentProducts.map((prod) => (
                      <TableRow key={prod.id} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/20">
                        <TableCell className="py-2.5 font-medium text-xs text-zinc-800 dark:text-zinc-200">{prod.name}</TableCell>
                        <TableCell className="py-2.5 text-xs text-zinc-400 capitalize">{prod.category.replace("-", " ")}</TableCell>
                        <TableCell className="py-2.5 text-xs font-semibold text-zinc-900 dark:text-zinc-100">${prod.price}</TableCell>
                        <TableCell className="py-2.5 text-xs">
                          <Badge 
        ...
        <div className="space-y-6">
          <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800/80">
            <CardHeader className="pb-3 border-b border-zinc-100 dark:border-zinc-800/60">
              <CardTitle className="text-sm font-bold text-zinc-900 dark:text-zinc-50">Quick Workspace Actions</CardTitle>
            ...
            <CardContent className="pt-4 space-y-3">
              <Link href={`/${brandId}/cc?action=new-product`} className="block">
                <div className="flex items-center gap-3 p-3 rounded-lg border border-zinc-150 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800/40 transition-colors select-none">
                  <div className="w-8 h-8 rounded bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 flex items-center justify-center text-sm font-bold shrink-0">
                    📦
                  </div>
                  <div>
                    <h4 className="text-xs font-bold text-zinc-800 dark:text-zinc-200">Add New Product</h4>
              ...
              {isLicenseAdmin && (
                <Link href={`/${brandId}/admin?action=generate`} className="block">
                  <div className="flex items-center gap-3 p-3 rounded-lg border border-zinc-150 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800/40 transition-colors select-none">
                    <div className="w-8 h-8 rounded bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center text-sm font-bold shrink-0">
                      🔑
                    </div>
                    <div>
                      <h4 className="text-xs font-bold text-zinc-800 dark:text-zinc-200">Issue License Key</h4>
              ...
              <Link href={`/${brandId}/seo`} className="block">
                <div className="flex items-center gap-3 p-3 rounded-lg border border-zinc-150 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800/40 transition-colors select-none">
                  <div className="w-8 h-8 rounded bg-amber-500/10 text-amber-600 dark:text-amber-400 flex items-center justify-center text-sm font-bold shrink-0">
                    🔍
                  </div>
                  <div>
                    <h4 className="text-xs font-bold text-zinc-800 dark:text-zinc-200">Audit SEO Settings</h4>
              ...
              {isBrandManager && (
                <Link href={`/${brandId}/brand`} className="block">
                  <div className="flex items-center gap-3 p-3 rounded-lg border border-zinc-150 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800/40 transition-colors select-none">
                    <div className="w-8 h-8 rounded bg-purple-500/10 text-purple-650 dark:text-purple-400 flex items-center justify-center text-sm font-bold shrink-0">
                      ⚙️
                    </div>
                    <div>
                      <h4 className="text-xs font-bold text-zinc-800 dark:text-zinc-200">Edit Settings</h4>
