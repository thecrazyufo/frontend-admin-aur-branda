...
const CouponIcon = (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M21 12V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v5a2 2 0 0 1 0 4v3a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-3a2 2 0 0 1 0-4z"/>
...
export const ROLE_NAV_REGISTRY: Record<string, NavigationItem[]> = {
  ...
  ADMIN: [
    ...
    { label: "Content & Catalog", path: "/cc", icon: ProductIcon },
    ...
    { label: "Discount Coupons", path: "/admin?tab=coupons", icon: CouponIcon },
  ],
  SEO: [
    { label: "Product Manager", path: "/cc/products", icon: ProductIcon },
    { label: "Blog Manager", path: "/cc/blogs", icon: ContentIcon },
    { label: "FAQ Manager", path: "/cc/faqs", icon: HelpIcon },
    { label: "Category Manager", path: "/cc/categories", icon: TagIcon },
    { label: "Guide Manager", path: "/cc/help", icon: BookIcon },
    { label: "Career Manager", path: "/cc/careers", icon: BriefcaseIcon },
  ...
  WRITER: [
    { label: "Overview", path: "", icon: DashboardIcon },
    { label: "Product Manager", path: "/cc/products", icon: ContentIcon },
  ],
  LICENSE_ADMIN: [
    { label: "Overview", path: "", icon: DashboardIcon },
    { label: "License Admin", path: "/admin", icon: LicenseIcon },
