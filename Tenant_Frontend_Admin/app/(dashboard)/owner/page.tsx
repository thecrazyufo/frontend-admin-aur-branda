  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      <div className="flex flex-col gap-1">
        <h1 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">Super Admin Credentials Panel</h1>
        <p className="text-xs text-zinc-500 dark:text-zinc-400 font-medium">Create and manage logins, assigning roles and brand isolations.</p>
      </div>

      {error && (
        <div className="flex items-center gap-3 p-3.5 rounded-lg border border-red-200 dark:border-red-900/30 bg-red-50/50 dark:bg-red-950/20 text-xs font-semibold text-red-600 dark:text-red-400 animate-fade-in">
      ...
      {success && (
        <div className="flex items-center gap-3 p-3.5 rounded-lg border border-emerald-200 dark:border-emerald-900/30 bg-emerald-50/50 dark:bg-emerald-950/20 text-xs font-semibold text-emerald-600 dark:text-emerald-400 animate-fade-in">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6 items-start">
        {/* User Form Card */}
        <Card className="dark:bg-zinc-900 shadow-sm border border-zinc-200 dark:border-zinc-800">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                <label htmlFor="username" className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Username</label>
                <Input
                  id="username"
                  type="text"
                  value={username}
              ...
              <div className="space-y-1.5">
                <label htmlFor="password" className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Password</label>
                <Input
                  id="password"
                  type="text"
                  value={password}
              ...
              <div className="space-y-1.5">
                <label htmlFor="fullName" className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Full Name</label>
                <Input
                  id="fullName"
                  type="text"
                  value={fullName}
              ...
              <div className="space-y-1.5">
                <label htmlFor="email" className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Email Address</label>
                <Input
                  id="email"
                  type="email"
                  value={email}
              ...
              <div className="space-y-1.5">
                <label htmlFor="role" className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Role Scope</label>
                <Select
                  id="role"
                  value={role}
              ...
              <div className="space-y-1.5">
                <label htmlFor="brandId" className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Brand Scope</label>
                <Select
                  id="brandId"
                  value={brandId}
        ...
        {/* User List Card */}
        <Card className="dark:bg-zinc-900 shadow-sm border border-zinc-200 dark:border-zinc-800 overflow-hidden">
          <CardHeader className="pb-4 flex flex-row items-center justify-between border-b border-zinc-150 dark:border-zinc-800">
            <div>
                  ...
                  {users.filter(u => {
                    ...
                    <TableRow key={user.username}>
                      <TableCell className="font-semibold text-zinc-900 dark:text-zinc-150">
                        <span className="bg-zinc-100 dark:bg-zinc-800 border border-zinc-205 dark:border-zinc-700 px-2 py-1 rounded-md text-xs font-mono">{user.username}</span>
                      </TableCell>
                      <TableCell className="font-medium">{user.fullName || "N/A"}</TableCell>
                      <TableCell className="text-zinc-500 dark:text-zinc-400 text-xs">{user.email || "N/A"}</TableCell>
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            type="button"
                            className="text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 p-1 rounded transition-colors cursor-pointer border-0 bg-transparent"
                      ...
                      <TableCell className="text-zinc-500 dark:text-zinc-400 font-mono text-xs">{user.brandId}</TableCell>
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          <Button
                            variant="outline"
                            size="icon"
                            className="w-7 h-7 text-zinc-500 hover:text-zinc-950 dark:hover:text-zinc-150"
                          ...
                          <Button
                            variant="outline"
                            size="icon"
                            className="w-7 h-7 text-zinc-500 hover:text-red-600 dark:hover:text-red-400"
