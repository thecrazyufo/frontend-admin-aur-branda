...
export function MarkdownEditor({
  ...
  return (
    <div className={cn("flex flex-col rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden bg-white dark:bg-zinc-900/50 shadow-sm", className)}>

      {/* ── Top bar: Toolbar + Mode switcher ─────────────────────────────── */}
      <div className="flex flex-wrap items-center gap-1 px-2 py-1.5 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 shrink-0">

        {/* Formatting buttons */}
        <div className="flex flex-wrap items-center gap-0.5 flex-1 min-w-0">
          {/* Heading group */}
          <div className="flex items-center gap-0 border-r border-zinc-200 dark:border-zinc-700 pr-1.5 mr-1">
        ...
        {/* Mode switcher */}
        <div className="flex items-center gap-0.5 p-0.5 bg-zinc-100 dark:bg-zinc-800 rounded-lg shrink-0">
      ...
      <div className={cn("flex overflow-hidden", mode === "split" ? "divide-x divide-zinc-200 dark:divide-zinc-800" : "")}>
        ...
        {(mode === "preview" || mode === "split") && (
          ...
          >
            {previewHtml ? (
              ...
              <p className="text-zinc-400 dark:text-zinc-600 text-xs italic mt-2">
      ...
      {/* ── Footer: Stats + Hint ─────────────────────────────────────────── */}
      <div className="flex items-center justify-between px-3 py-1.5 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 shrink-0">
