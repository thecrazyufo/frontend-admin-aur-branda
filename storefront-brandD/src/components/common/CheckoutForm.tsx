...
import { CheckCircle, ShieldCheck, CreditCard, Key, Printer, Copy, RefreshCw } from "lucide-react";
...
export default function CheckoutForm({ product, selectedTierName, siteId }: CheckoutFormProps) {
  ...
  const handleCheckoutSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await CheckoutAPI.completeCheckout({
      ...
      setError("Checkout failed. Please check backend connection and try again.");
    } finally {
      setLoading(false);
    }
  };
